...
<body bgcolor="#D9DFAA">
	<table border="1" cellspacing="1" cellpadding="8" width="700">
		...
		<tr>
			...
			<td>
				<a href="deleteOneXscj.action?cj.id.xh=<s:property value="#xscj[0]"/>&cj.id.kch=
					<s:property value="#xscj[5]"/>" onClick="if(!confirm('确定删除该信息吗？')) 
					return false;else return true;">删除</a>
			</td>
		</tr>
		</s:iterator>
		<tr align="left">
